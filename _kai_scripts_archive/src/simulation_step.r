...
simulation_step <- function(before_footprint = list(function() {output}),
  ...
  try({
    ...
    if (run_trajec) {
      ...
      met_files <- c(
        find_met_files(r_run_time, "%Y%m%d_%H*", n_hours, "/uufs/chpc.utah.edu/common/home/lin-group12/hrrr/hrrr"), 
        find_met_files(r_run_time, '%Y%m%d_gfs0p25', n_hours, '/uufs/chpc.utah.edu/common/home/lin-group18/KaiW/fluorine/gfs')
      )
      ...
      # Function to calculate fraction of trajectory instances in given altitude bin
      #source("/uufs/chpc.utah.edu/common/home/lin-group19/KaiW/mercury_SPL/altitude_by_time.R")
